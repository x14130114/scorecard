...
public class glenmills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glenmills);
        ...
        MySQLiteHelper db = new MySQLiteHelper(glenmills.this);
        List<Overall> overall = db.getAllScores();
        String[] names = new String[overall.size()];
        mpl = MediaPlayer.create(glenmills.this, R.raw.crowdcheer);
        ...
        bViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(glenmills.this,viewAll.class);
        ...
        bAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(glenmills.this,glenmills.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final MediaPlayer mp = MediaPlayer.create(glenmills.this, R.raw.crowdcheer);
                switch (v.getId()) {
                    case R.id.submit1:
                        //mp.start();
