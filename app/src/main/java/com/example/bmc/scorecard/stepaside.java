...
public class stepaside extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stepaside);
        ...
        MySQLiteHelper db = new MySQLiteHelper(stepaside.this);
        List<Overall> overall = db.getAllScores();
        String[] names = new String[overall.size()];
        mpl = MediaPlayer.create(stepaside.this, R.raw.crowdcheer);
        ...
        bViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(stepaside.this,viewAll.class);
        ...
        bAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(stepaside.this,stepaside.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final MediaPlayer mp = MediaPlayer.create(stepaside.this, R.raw.crowdcheer);
                switch (v.getId()) {
                    case R.id.submit1:
                        //mp.start();
